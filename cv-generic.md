...
Progressed from DBA / SQL Architect through IT Manager and Vice President of IT before appointment as the organization's first Chief Technology Officer in its 45-year history; served in that role for 8 years. Led the technology function through multi-year modernization and multiple full enterprise migrations, under continuous PCI-DSS, HIPAA, and CARD Act oversight.
...
- Founded and ran a web and IT consulting firm for 17 years with full P&L ownership and direct executive responsibility for financial management, hiring, talent development, client delivery, and operations.
- Architected and launched a proprietary, commercial-grade content management platform that supported dozens of content-driven websites and frequently served as clients' first digital presence.
- Built a durable operation (12 people at peak, $4M+ peak revenue) founded on 10+ year client relationships across a 50-client portfolio (legal, tax, manufacturing, national nonprofits).
